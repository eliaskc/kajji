...
export class InteractiveJj extends Context.Service<InteractiveJj, InteractiveJjService>()(
    "kajji/InteractiveJj",
) {}

export const InteractiveJjLive: Layer.Layer<InteractiveJj, never, InteractiveProcess> =
    Layer.effect(
        InteractiveJj,
        Effect.gen(function* () {
